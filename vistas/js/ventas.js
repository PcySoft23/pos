...
// CARGAMOS LAS IMAGENES CUANDO INTERACTUAMOS CON EL FILTRO ORDENAR 
...
$(".formularioVenta").on("click","button.quitarProducto", function(){
	...
	// ALMACENAR EN EL LOCALSTORAGE EL ID PRODUCTO A QUITAR
	if(localStorage.getItem("quitarProducto")==null){
		idQuitarProducto=[];
	}else{
...
/**************************************************
AGREGAR PRODUCTO DESDE EL BOTON PARA DISPOSITIVOS
***************************************************/
var numProducto=0;
...
***************************************************/
 function agregarImpuesto(){
	...
	var totaConImpuesto=Number(precioImpuesto)+Number(precioTotal);

	$("#nuevoTotalVenta").val(totaConImpuesto);
	$("#totalVenta").val(totaConImpuesto);
